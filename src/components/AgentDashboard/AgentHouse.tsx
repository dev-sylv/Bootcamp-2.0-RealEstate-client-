    ...
    return (
        ...
        <Body>
            ...
            <Contain>
                ...
                <TotalAgent style={{fontSize:"17px"}}>Houses Uploaded</TotalAgent> 
                </Total>
                ...
                <TotalAgent style={{fontSize:"17px"}}>Total Properties Available</TotalAgent> 
                </Total>
                ...
                <TotalAgent style={{fontSize:"17px"}}>Total Number of Prospect</TotalAgent> 
                </Total>
                ...
                <TotalAgent style={{fontSize:"17px"}}>Properties Sold</TotalAgent> 
